        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceDefaultId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entries_Libraries_LibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PracticeSessions_Libraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "Libraries",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearningStates_Entries_EntryId",
                        column: x => x.EntryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAnswer = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attempts_Entries_EntryId",
                        column: x => x.EntryId,
                        principalTable: "Entries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningStates_EntryId_SourceLanguage_TargetLanguage",
                table: "LearningStates",
                columns: new[] { "EntryId", "SourceLanguage", "TargetLanguage" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LearningStates_NextReviewAt",
                table: "LearningStates",
                column: "NextReviewAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeSessions_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translations_EntryId_LanguageCode",
                table: "Translations",
                columns: new[] { "EntryId", "LanguageCode" },
                unique: true);
        }
